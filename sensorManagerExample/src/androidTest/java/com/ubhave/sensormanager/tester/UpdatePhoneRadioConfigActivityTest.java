...
public class UpdatePhoneRadioConfigActivityTest
{
	@Rule
	public ActivityTestRule<UpdatePhoneRadioConfigActivity> mActivityRule = new ActivityTestRule<>(
			UpdatePhoneRadioConfigActivity.class, false, false);

	@Before
	public void setUp() throws Exception
	{
		Intent intent = new Intent();
		intent.putExtra(AbstractUpdateSensorConfigActivity.SENSOR_TYPE_ID, SensorUtils.SENSOR_TYPE_PHONE_RADIO);
