...
public class UpdateLocationConfigActivityTest
{
	@Rule
	public ActivityTestRule<UpdateLocationConfigActivity> mActivityRule = new ActivityTestRule<>(
			UpdateLocationConfigActivity.class, false, false);

	@Before
	public void setUp() throws Exception
	{
		Intent intent = new Intent();
		intent.putExtra(AbstractUpdateSensorConfigActivity.SENSOR_TYPE_ID, SensorUtils.SENSOR_TYPE_LOCATION);
