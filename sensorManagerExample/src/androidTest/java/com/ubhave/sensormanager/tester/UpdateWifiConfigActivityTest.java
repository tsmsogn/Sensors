...
public class UpdateWifiConfigActivityTest
{
	@Rule
	public ActivityTestRule<UpdateWifiConfigActivity> mActivityRule = new ActivityTestRule<>(
			UpdateWifiConfigActivity.class, false, false);

	@Before
	public void setUp() throws Exception
	{
		Intent intent = new Intent();
		intent.putExtra(AbstractUpdateSensorConfigActivity.SENSOR_TYPE_ID, SensorUtils.SENSOR_TYPE_WIFI);
