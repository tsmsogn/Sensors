...
public class UpdateStepCounterConfigActivityTest
{
	@Rule
	public ActivityTestRule<UpdateStepCounterConfigActivity> mActivityRule = new ActivityTestRule<>(
			UpdateStepCounterConfigActivity.class, false, false);

	@Before
	public void setUp() throws Exception
	{
		Intent intent = new Intent();
		intent.putExtra(AbstractUpdateSensorConfigActivity.SENSOR_TYPE_ID, SensorUtils.SENSOR_TYPE_STEP_COUNTER);
