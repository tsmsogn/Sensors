...
public class UpdateBluetoothConfigActivityTest
{
	@Rule
	public ActivityTestRule<UpdateBluetoothConfigActivity> mActivityRule = new ActivityTestRule<>(
			UpdateBluetoothConfigActivity.class, false, false);

	@Before
	public void setUp() throws Exception
	{
		Intent intent = new Intent();
		intent.putExtra(AbstractUpdateSensorConfigActivity.SENSOR_TYPE_ID, SensorUtils.SENSOR_TYPE_BLUETOOTH);
