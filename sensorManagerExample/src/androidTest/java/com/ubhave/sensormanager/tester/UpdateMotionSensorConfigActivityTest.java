...
public class UpdateMotionSensorConfigActivityTest
{
	@Rule
	public ActivityTestRule<UpdateMotionSensorConfigActivity> mActivityRule = new ActivityTestRule<>(
			UpdateMotionSensorConfigActivity.class, false, false);

	@Before
	public void setUp() throws Exception
	{
		Intent intent = new Intent();
		intent.putExtra(AbstractUpdateSensorConfigActivity.SENSOR_TYPE_ID, SensorUtils.SENSOR_TYPE_ACCELEROMETER);
